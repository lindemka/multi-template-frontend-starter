...
public class UserProfileDataFactory {
    ...
    public List<UserProfile> createAllProfiles() {
    ...
    public List<UserProfile> createFounders() {
        return Arrays.asList(
            createProfile(1L, "Ahmed Salman", "New York City, US", "https://i.pravatar.cc/150?img=14", 342, 4.5,
            ...
            createProfile(2L, "Andy Mitchell", "San Francisco, US", "https://i.pravatar.cc/150?img=33", 1289, 5.0,
            ...
            createProfile(3L, "Kinne Zhang", "London, UK", "https://i.pravatar.cc/150?img=5", 567, 4.8,
    ...
    public List<UserProfile> createInvestors() {
        return Arrays.asList(
            createProfile(14L, "Sophia Martinez", "Miami, US", "https://i.pravatar.cc/150?img=23", 2341, 4.9,
    ...
    public List<UserProfile> createDevelopers() {
        return Arrays.asList(
            createProfile(4L, "Brent Thompson", "Berlin, Germany", "https://i.pravatar.cc/150?img=7", 423, 4.5,
    ...
    public List<UserProfile> createAdvisors() {
        return Arrays.asList(
            createProfile(16L, "Nina Patel", "Austin, US", "https://i.pravatar.cc/150?img=26", 432, 4.7,
    ...
    private UserProfile createProfile(Long ignored, String name, String location, String avatar, int followers, double rating,
        ...
        if (startupTag != null) {
            UserProfile.Asset asset = new UserProfile.Asset();
            asset.setType(startupTag);
            asset.setLabel(startupName);
            profile.setAssets(asset);
        }
