// Shared mock data for members and profiles
export const mockFoundersData = [
  {
    id: 1,
    name: "Ahmed Salman",
  ...
  },
  {
    ...
    tagline: "Partner @ Emerge Ventures | Impact-Driven Investor",
    about: {
      short: "Investing in early-stage startups that create positive social and environmental impact.",
      industries: ["Food & Beverage", "Social Impact & Community Development", "Tech"],
      lookingFor: "Mission-driven founders solving real-world problems.",
      offering: "Seed funding, strategic guidance, network access, operational support.",
  ...
  },
  {
    ...
    assets: null,
    status: null,
    tagline: "Hardware + Software Engineer | Space Tech Enthusiast",
    about: {
      short: "Building next-generation consumer electronics with a focus on space technology applications.",
      industries: ["Consumer Hardware & Electronics", "Space Technology & Exploration", "AI & Machine Learning"],
      lookingFor: "Co-founders with hardware expertise and investors in deep tech.",
      offering: "Full-stack development, embedded systems, product strategy.",
  ...
  },
  {
    ...
    tagline: "Data Scientist | BioTech Specialist",
    about: {
      short: "Applying machine learning to accelerate drug discovery and personalized medicine.",
      industries: ["Healthcare & Medical Devices", "Biotech & Pharmaceuticals", "AI & Machine Learning"],
      lookingFor: "Innovative biotech startups working on cutting-edge therapies.",
      offering: "PhD in Bioinformatics, expertise in ML for genomics, clinical data analysis.",
  ...
  },
  {
    ...
    status: null,
    tagline: "Serial Entrepreneur | Angel Investor | Tech Advisor",
    about: {
      short: "Building and investing in the next generation of SaaS companies.",
      industries: ["Software & SaaS", "AI & Machine Learning", "Tech"],
      lookingFor: "B2B SaaS startups with strong product-market fit.",
      offering: "Angel funding, technical mentorship, go-to-market strategy, network introductions.",
      languages: ["English"]
    }
  },
  {
    ...
    status: "Pre-Seed",
    tagline: "Founder @ SocialGood | Making Philanthropy Accessible",
    about: {
      short: "Creating a platform that connects donors with verified social impact projects worldwide.",
      industries: ["Social Impact & Community Development", "Tech", "Marketing & Sales"],
      lookingFor: "Technical co-founder and impact investors.",
      offering: "Non-profit sector expertise, fundraising experience, marketing strategy.",
  ...
  },
  {
    ...
    tagline: "CEO @ SpaceTech Solutions | Democratizing Space Data",
    about: {
      short: "Building satellite data analytics platform for agriculture and climate monitoring.",
      industries: ["Space Technology & Exploration", "AI & Machine Learning"],
      lookingFor: "Seed investors and ML engineers passionate about space tech.",
      offering: "Ex-SpaceX, deep space industry knowledge, proven product development.",
      languages: ["English", "Korean"]
    }
  },
  {
    ...
    assets: null,
    status: null,
    tagline: "Senior Product Designer | UX Strategist",
    about: {
      short: "Creating delightful user experiences that drive business growth.",
      industries: ["Human-Machine Interaction & UX Design", "Product & Design", "Tech"],
      lookingFor: "Product-focused startups that value design excellence.",
      offering: "10+ years design experience, user research, design systems, prototyping.",
      languages: ["English"]
    }
  },
  {
    ...
    about: {
      short: "Building scalable web applications with modern JavaScript technologies.",
      industries: ["Software & SaaS", "Tech"],
      lookingFor: "Fast-growing startups with interesting technical challenges.",
      offering: "5+ years full-stack experience, React, Node.js, AWS, DevOps.",
      languages: ["English", "Mandarin"]
    }
  },
  {
    ...
    status: null,
    tagline: "Managing Partner @ Hospitality Ventures",
    about: {
      short: "Investing in the future of travel, hospitality, and food tech.",
      industries: ["Tourism & Hospitality", "Food & Beverage", "Tech"],
      lookingFor: "Innovative startups disrupting the hospitality industry.",
      offering: "$500K-$5M investments, industry expertise, strategic partnerships.",
  ...
  },
  {
    ...
    tagline: "Founder @ SecureAI | Making Cybersecurity Intelligent",
    about: {
      short: "Using AI to detect and prevent cyber threats in real-time.",
      industries: ["Safety & Security Solutions", "AI & Machine Learning", "Software & SaaS"],
      lookingFor: "Series A investors and senior security engineers.",
      offering: "Ex-Microsoft Security, patent-pending technology, $2M ARR.",
      languages: ["English"]
    }
  },
  {
    ...
    assets: null,
    status: null,
    tagline: "Product Manager | HealthTech Innovation",
    about: {
      short: "Bridging the gap between healthcare providers and technology.",
      industries: ["Healthcare & Medical Devices", "Biotech & Pharmaceuticals"],
      lookingFor: "HealthTech startups focused on improving patient outcomes.",
      offering: "Clinical background, product management, data analytics, regulatory knowledge.",
  ...
  },
  {
    ...
    status: "Bootstrapped",
    tagline: "Founder @ LocalEats | Empowering Local Food Businesses",
    about: {
      short: "Connecting local restaurants with customers while supporting community development.",
      industries: ["Food & Beverage", "Tourism & Hospitality", "Social Impact & Community Development"],
      lookingFor: "Growth capital and technical co-founder.",
      offering: "Restaurant industry expertise, local market knowledge, proven business model.",
  ...
  },
  {
    ...
    status: null,
    tagline: "Director @ TechStars Berlin | Startup Ecosystem Builder",
    about: {
      short: "Accelerating European startups to global scale.",
      industries: ["Tech", "AI & Machine Learning", "Software & SaaS"],
      lookingFor: "Ambitious founders ready to scale globally.",
      offering: "3-month accelerator program, $120K investment, global mentor network.",
  ...
  },
  {
    ...
    tagline: "Senior Backend Engineer | Distributed Systems Expert",
    about: {
      short: "Building scalable backend systems that power millions of users.",
      industries: ["Software & SaaS", "Tech"],
      lookingFor: "High-growth startups with interesting scaling challenges.",
      offering: "Ex-Amazon, distributed systems, microservices, cloud architecture.",
      languages: ["English"]
    }
  },
  {
    ...
    status: "Raising Seed",
    tagline: "Founder @ ImpactHub | Design for Social Good",
    about: {
      short: "Creating technology solutions that address social inequality.",
      industries: ["Social Impact & Community Development", "Human-Machine Interaction & UX Design"],
      lookingFor: "Impact investors and engineers passionate about social change.",
      offering: "Non-profit experience, design thinking, community engagement.",
      languages: ["English"]
    }
  },
  {
    ...
    status: null,
    tagline: "Technical Advisor | Fractional CTO",
    about: {
      short: "Helping startups build robust technical foundations and scale engineering teams.",
      industries: ["AI & Machine Learning", "Software & SaaS", "Tech"],
      lookingFor: "Early-stage startups needing technical guidance.",
      offering: "20+ years experience, architecture reviews, team building, technical strategy.",
      languages: ["English"]
    }
  },
  {
    ...
    status: "MVP Launched",
    tagline: "Founder @ TravelConnect | Reimagining Group Travel",
    about: {
      short: "Making group travel planning seamless and enjoyable.",
      industries: ["Tourism & Hospitality", "Marketing & Sales", "Product & Design"],
      lookingFor: "Seed funding and backend engineers.",
      offering: "Travel industry expertise, product design, growth marketing.",
  ...
  },
  {
    ...
    about: {
      short: "Building smart devices that connect the physical and digital worlds.",
      industries: ["Consumer Hardware & Electronics", "AI & Machine Learning"],
      lookingFor: "Hardware startups working on innovative IoT solutions.",
      offering: "Embedded systems, IoT protocols, product development, manufacturing.",
  ...
  },
  {
    ...
    tagline: "Partner @ HealthTech Capital | Investing in Digital Health",
    about: {
      short: "Backing founders building the future of healthcare delivery.",
      industries: ["Healthcare & Medical Devices", "Biotech & Pharmaceuticals", "AI & Machine Learning"],
      lookingFor: "Digital health startups with validated clinical outcomes.",
      offering: "Series A-B investments, healthcare network, regulatory guidance.",
      languages: ["English"]
    }
  },
  {
    ...
    status: "Series B",
    tagline: "Founder @ SmartBuild MENA | Digital Transformation in Construction",
    about: {
      short: "Digitizing construction management across the Middle East and North Africa.",
      industries: ["Architecture & Construction", "AI & Machine Learning", "Safety & Security Solutions"],
      lookingFor: "Series B investors and regional expansion partners.",
      offering: "MENA market expertise, government contracts, proven traction in 5 countries.",
      languages: ["Arabic", "English", "French"]
    }
  }
];

export const mockExtendedProfiles = {
  peopleViewed: [
